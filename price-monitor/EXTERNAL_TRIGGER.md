...
3. **Generate new token**
   ...
   - **Repository access**: **Only select repositories** → `xf1lux-10282/claude` を選択
...
3. **Common（基本）**
   ...
   - **URL**:
     ```
     https://api.github.com/repos/xf1lux-10282/claude/actions/workflows/price-monitor.yml/dispatches
     ```
4. **Schedule（実行時刻）**
   - タイムゾーンを **Asia/Tokyo** に設定
   - 実行時刻を選ぶ（例: 6:00, 9:00, 12:00, 15:00, 18:00, 21:00）
