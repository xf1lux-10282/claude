...
- ✅ **参考指標を追加**（PR #14, #16）：購入商品とは別に、相場の参考として
  プラチナ/パラジウムの地金スポット価格と USD/JPY をダッシュボードに表示。
  - `metals.py`：地金 USD/oz を取得（Yahoo `PL=F`/`PA=F` → stooq フォールバック。**Yahooで取得実績あり**）。
  ...
  - 実機値（2026-06-07）：プラチナ ¥9,257/g、パラジウム ¥6,506/g。
  - SWキャッシュは v4。
