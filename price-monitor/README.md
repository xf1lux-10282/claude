...
| #14 | 2026-06-07 | **参考指標を追加**。プラチナ/パラジウムの地金スポット価格(USD/oz、Yahoo→stooqフォールバック)とUSD/JPYをダッシュボードに「参考指標」セクションとして追加。金属は **USD/oz と 円/g** の二軸表示（購入商品ではなく相場の参考）。`metals.py` 追加・SWキャッシュ v3 |
