...
def generate_v23_highlight_boost():
    """v23カーブを生成 - ハイライト強化版"""
    print("=" * 80)
    print("PX1V-PtPd-v23: ハイライト強化版")
    print("=" * 80)
    ...
    # アンカーポイント（Input 240, 248, 255）
    anchor_inputs = [240, 248, 255]
    anchor_quads = [v23_quad_values[240], v23_quad_values[248], v23_quad_values[255]]
    ...
    with open(output_quad, 'w') as f:
        ...
        f.write('# PX1V-PtPd-v23 - Highlight Boost (based on v22)\n')
        f.write('# Input 0-240: v22 Quad values (unchanged)\n')
        f.write('# Input 248: v22 Input 255 Quad (measured 1.23D)\n')
        f.write('# Input 255: v20 Input 248 Quad (measured 1.27D)\n')
        f.write('# Linear interpolation for 241-247, 249-254\n')
    ...
    axes[0, 0].set_title('v23: Highlight Boost (248, 255)',
    ...
    axes[0, 1].set_title('v23: Extended Highlight Range',
                         fontsize=14, fontweight='bold')
    axes[0, 1].legend()
    ...
    axes[1, 0].set_title('v23: Boundary Line Risk Analysis',
                         fontsize=14, fontweight='bold')
    axes[1, 0].legend()
    ...
    axes[1, 1].set_title('v23: Highlight Quad Differences (224-255)',
                         fontsize=14, fontweight='bold')
    axes[1, 1].legend()
    ...
    plt.tight_layout()
    plt.savefig('v23_highlight_boost_analysis.png', dpi=300, bbox_inches='tight')
    print(f"✓ グラフ保存: v23_highlight_boost_analysis.png")
...
if __name__ == '__main__':
    quad_values, densities = generate_v23_highlight_boost()

    print("\n" + "=" * 80)
    print("v23 カーブ生成完了 - ハイライト強化版")
